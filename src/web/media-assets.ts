...
export const mediaI18nZh = {
  ...
  mediaMcpToolsHint:"选择对外暴露的 MCP 工具。默认开启图片/视频工具，voice/TTS 相关工具默认关闭以节省 agent 上下文。勾选后自动保存。",
...
export const mediaI18nEn = {
  ...
  mediaMcpToolsHint:"Choose which MCP tools this account exposes. Defaults keep image/video tools on and all voice/TTS tools off to save agent context. Changes save automatically.",
